...
<body>
    ...
    <script>
        let currentUser=null, authMode='signup', tokenBalance=100, notifCount=0, cameraStream=null, cameraActive=false, recognition=null, voiceActive=false, isAuthenticated=false;
